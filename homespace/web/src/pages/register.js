          ...
          <div className="w-full max-w-md animate-slide-up">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <label className="flex items-start gap-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                />
                <span>Я согласен с <span className="text-indigo-600 dark:text-indigo-400 underline">условиями использования</span> и <span className="text-indigo-600 dark:text-indigo-400 underline">политикой конфиденциальности</span></span>
              </label>
