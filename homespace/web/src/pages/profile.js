...
import { User, Camera, Edit2, Save, TrendingUp, TrendingDown, PiggyBank, Calendar, Phone, Mail, Users, Crown, Lock } from 'lucide-react';
                ...
                {profile?.has_subscription ? (
                  ...
                  <div>
                    ...
                    <Link href="/subscription">
                      <Button variant="secondary" size="sm" className="mt-3 w-full" icon={<Crown className="w-4 h-4" />}>
                        Купить подписку
                      </Button>
                    </Link>
                  </div>
